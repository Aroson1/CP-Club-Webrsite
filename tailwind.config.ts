  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%, 100%': { 
            boxShadow: '0 0 10px 2px rgba(49, 225, 247, 0.3), 0 0 15px 5px rgba(225, 49, 247, 0.2)',
          },
          '50%': {
            boxShadow: '0 0 15px 3px rgba(49, 225, 247, 0.4), 0 0 20px 7px rgba(225, 49, 247, 0.3)',
          },
        }
      },
      animation: {
